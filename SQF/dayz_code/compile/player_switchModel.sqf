...
private ["_weapons","_magazines","_primweapon","_secweapon"];
	...
	if ( (_playerUID == dayz_playerUID) && (count _magazines == 0) && (count (magazines player) > 0 )) exitWith {cutText [localize 'str_epoch_player_153', "PLAIN DOWN"]};


//	if ( count _magazines == 0 ) exitWith {cutText [localize 'str_epoch_player_153', "PLAIN DOWN"]};
