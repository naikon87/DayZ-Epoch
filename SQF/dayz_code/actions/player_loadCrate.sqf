...
if(TradeInprogress) exitWith { cutText [localize 'str_epoch_player_80' , "PLAIN DOWN"]; };
TradeInprogress = true;

_hasTool = 	"ItemCrowbar" in items player;
if(!_hasTool) exitWith { 
	cutText [localize 'str_epoch_player_81', "PLAIN DOWN"];
...
cutText [localize 'str_epoch_player_83', "PLAIN DOWN"];
